...
// +kubebuilder:rbac:groups=metal3.io,resources=switchports/finalizers,verbs=update;delete
...
// +kubebuilder:rbac:groups=metal3.io,resources=switchportconfigurations/finalizers,verbs=update;delete

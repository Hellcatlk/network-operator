...
// +kubebuilder:rbac:groups=metal3.io,resources=openvswitches,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=metal3.io,resources=openvswitches/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=metal3.io,resources=openvswitches/finalizers,verbs=update
